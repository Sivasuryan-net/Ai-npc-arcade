...
def is_visible(image):
    """Treat surfaces without explicit alpha as visible."""
...
class ControlSettingScreen():
    ...
    def hit_ui_element(self, pos):
        ...
        """
        x, y = pos
        if (is_visible(self.jumpIm.image)
        ...
        elif (is_visible(self.moveLeftIm.image)
            ...
            return self.currently_selected
        elif (is_visible(self.moveRightIm.image)
            ...
            return self.currently_selected
        elif (is_visible(self.aimXIm.image)
            ...
            return self.currently_selected
        elif (is_visible(self.aimMXIm.image)
            ...
            return self.currently_selected
        elif (is_visible(self.aimYIm.image)
            ...
            return self.currently_selected
        elif (is_visible(self.aimMYIm.image)
    ...
    def update_input_layout(self, actions_map,
        ...
        """
        for action, control in actions_map.items():
